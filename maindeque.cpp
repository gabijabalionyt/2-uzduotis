...
int maindeque()
{
 ...
 cout << "Kaip norite apskaiciuoti studento galutini pazymi?\nSpauskite 1, jei norite, jog butu naudojamas studento rezultatu vidurkis,\n2, jei norite, jog butu naudojama mediana." << endl;
        ...
        while (true)
        {
            ...
            deque<Student> Failed;
            deque<Student>::iterator IT = S.begin();
            while (IT != S.end())
            {
            ...
            deque<Student> Passed;
            deque<Student>::iterator II = S.begin();
            while (IT != S.end())
            {
            ...
            for (deque<Student>::iterator IT = Failed.begin(); IT != Failed.end(); IT++)
            {
            ...
            for (deque<Student>::iterator IT = Passed.begin(); IT != Passed.end(); IT++)
            {
